...
@interface RCTWebView () <WKUIDelegate, WKNavigationDelegate, WKScriptMessageHandler, UIScrollViewDelegate, RCTAutoInsetsProtocol>
...
- (void)layoutSubviews
{
  ...
  // Ensure webview takes the position and dimensions of RCTWebView
